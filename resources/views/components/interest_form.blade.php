...
<div id="select-modal" tabindex="-1" aria-hidden="true"
     class="mt-12 opacity-0 transform scale-95 transition-all duration-500 ease-in-out overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
