...
<div x-data="setup()" :class="{ 'dark': isDark }">
    <div
        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            ...
            <!-- Task Summaries -->
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 p-4 gap-4 text-black dark:text-white">
                <div class="md:col-span-2 xl:col-span-3">
                    <h3 class="text-lg font-semibold">Flux RSS recent Links</h3>
                    <form class="" action="" method="post">
                            ...
                            <button class="bg-indigo-600 hover:bg-indigo-700 rounded-lg px-8 py-2 text-gray-100 text-sm hover:shadow-xl transition duration-150 uppercase">Sign Up</button>
                    </form>
                </div>
