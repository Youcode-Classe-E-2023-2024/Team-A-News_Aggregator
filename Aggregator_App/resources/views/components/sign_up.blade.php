<div>
    <form action="{{ route('form_register') }}" method="" class="border border-gray-300 bg-white rounded-md p-8">
        @csrf
        <form class="w-full">
            <div class="mb-6">
            ...
            <div class="!mt-10">
                <button type="button" class="w-full py-3 px-4 text-sm font-semibold rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                    Create an account
                </button>
            </div>
            <p class="text-sm mt-6 text-center">Already have an account? <a href="{{route('form_login')}}" class="text-blue-600 font-semibold hover:underline ml-1">Login here</a></p>
        </form>
</div>
