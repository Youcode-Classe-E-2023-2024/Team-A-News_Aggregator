          ...
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-gray-600 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                ...
                <div class="flex space-x-1 items-center">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" class="like-btn h-7 w-7 border-1 text-gray-200 hover:text-gray-100 transition duration-100 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
...
<script>
    ...
    likeBtn.addEventListener('click', () => {
        if(isFavLiked){
            liking('unlike', 'DELETE', 1, 1);
        }
        if(!isFavLiked){
            liking('like', 'POST', 1, 1);
        }
    });
    ////
...
<?php /**PATH C:\Users\YouCode\Desktop\Team-A-News_Aggregator\Aggregator_App\resources\views/components/favorite.blade.php ENDPATH**/ ?>