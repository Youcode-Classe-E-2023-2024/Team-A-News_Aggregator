...
class PushoverHandler extends SocketHandler
{
     ...
     * @param string|null  $title  Title sent to the Pushover Auth
    ...
    private function buildContent(LogRecord $record): string
    {
        ...
        // Only pass sounds that are supported by the Auth
