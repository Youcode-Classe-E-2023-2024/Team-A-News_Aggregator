...
/**
 * SendGridrHandler uses the SendGrid Auth v2 function to send Log emails, more information in https://sendgrid.com/docs/API_Reference/Web_API/mail.html
 *
...
{
    /**
     * The SendGrid Auth User
     */
    protected string $apiUser;

    /**
     * The SendGrid Auth Key
     */
    ...
    /**
     * @param string          $apiUser The SendGrid Auth User
     * @param string          $apiKey  The SendGrid Auth Key
