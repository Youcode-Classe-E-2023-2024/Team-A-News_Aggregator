...
class Router implements BindingRegistrar, RegistrarContract
{
    ...
    /**
     * Register an array of Auth resource controllers.
     *
     * @param  array  $resources
     * @param  array  $options
     * @return void
    ...
    /**
     * Route an Auth resource to a controller.
     *
     * @param  string  $name
     * @param  string  $controller
     * @param  array  $options
    ...
    /**
     * Register an array of Auth singleton resource controllers.
     *
     * @param  array  $singletons
     * @param  array  $options
     * @return void
    ...
    /**
     * Route an Auth singleton resource to a controller.
     *
     * @param  string  $name
     * @param  string  $controller
     * @param  array  $options
